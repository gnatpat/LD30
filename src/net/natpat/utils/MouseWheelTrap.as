package net.natpat.utils 
{
	...
	public class MouseWheelTrap { 
		...
		{
			//stage.addEventListener(MouseEvent.MOUSE_MOVE, function():void { allowBrowserScroll(false); trace("MOVE"); } );
		...
		private static function allowBrowserScroll(allow:Boolean):void
		{
			...
			if (ExternalInterface.available) {
				if (allow)
				{
					ExternalInterface.call("allowBrowserScroll");
				}
				else
				{
					
					ExternalInterface.call("denyBrowserScroll");
				}
			}
		}
